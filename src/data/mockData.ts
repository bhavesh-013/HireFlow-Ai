...
export type ResumeTemplate = AtsTemplateItem;
...
export const mockUser: UserProfile = {
  ...
  github: 'https://github.com/bhavesh-dev',
  linkedin: 'https://linkedin.com/in/bhavesh-dev',
...
export const mockTemplates: ResumeTemplate[] = templatesConfigService.getAllTemplates() as any[];
